...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'auxshp-template-' . $template . $sticky_sidebar_wrapper, $product ); ?>>
	<div class="auxshp-product-main clearfix">
		<?php
			...
			if ( auxin_is_true( $sticky_sidebar ) && in_array( $template, array('stack', 'sticky' ) ) ) :
				...
				<div class="summary entry-summary aux-sticky-position" data-boundry-target=".product .images" data-boundaries="true" data-sticky-move-method="after" data-use-transform="true" data-sticky-margin="<?php echo esc_attr( $sticky_header_height ); ?>" >
